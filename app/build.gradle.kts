...
android {
    ...
    defaultConfig {
        // Keep the alpha installable beside an existing HeliBoard installation.
        applicationId = "devcat.catboard"
        minSdk = 21
        targetSdk = 36
        versionCode = 4006
        ...
        androidComponents.onVariants { variant: ApplicationVariant ->
            ...
            variant.outputs.forEach { output ->
                if (output is com.android.build.api.variant.impl.VariantOutputImpl) {
                    output.outputFileName = "CatBoard_${defaultConfig.versionName}-${variant.buildType}.apk"
                }
            }
        }
    }
